"""Networking helpers for retries and rate limiting."""
...
class RateLimiter:
    """Simple random sleep limiter between requests."""
    ...
    def wait(self) -> None:
        """Sleep to keep request frequency reasonable."""
        now = time.monotonic()
...
class HttpClient:
    ...
    def get(self, url: str, **kwargs: Any) -> Response:
        """Fetch URL with retries, timeout and status validation."""
